what to change here? import React from 'react'
...
const getPasswords = async () => {
    let req = await fetch("https://passop-react-password-manager.onrender.com/")
...
const deletePassword = async (id) => {
    ...
    if (c) {
        ...
        await fetch("https://passop-react-password-manager.onrender.com/", { method: "DELETE", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ id }) })
